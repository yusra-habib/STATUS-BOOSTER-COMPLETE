...
<body>
  ...
  <!-- End Header -->
  <?php
    $postQuery="SELECT * FROM imageaus";
    $runPQ=mysqli_query($conn,$postQuery);
      ...
      <div class="main">
        ...
        echo "<img style='width='300' height='100'' src='$filepath' alt=''>";
            ...
            echo"<a  href='gallery_delete_aus.php?del_id=$row2[idImage] & del_img=$row2[imgFullNameImage]'> <button style='              
            ...
            echo"<a href='gallery_edit_aus.php?edit_id=$row2[idImage]'> <button type='submit'  name='delete_data' style='              
            background: linear-gradient(to bottom left, #c22d5e 40%, #5e0d21 100%);
            margin-left:25%;
            WIDTH:50%;
            color: white;
    ...
    ?>
          ...
          <a href="./upload_two.php"><button class="block" style=" display: block;
  width: 100%;
  border: none;
  background: linear-gradient(to bottom left, #c22d5e 40%, #5e0d21 100%);
