...
<body>
 ...
 <section id="header">
  ...
  <!-- End Header -->
  <?php
    $postQuery="SELECT * FROM imagepak";
        ...
        echo "<img style='width='300' height='100'' src='$filepath' alt=''>";
            echo "<div class='card_content'>";
              ...
              // following <p> only used to make button lokk good 
               ...
               echo"<a  href='gallery_delete_pak.php?del_id=$row2[idImage] & del_img=$row2[imgFullNameImage]'> <button style='              
               ...
               echo"<a href='gallery_edit_pak.php?edit_id=$row2[idImage]'> <button type='submit'  name='delete_data' style='              
               background: linear-gradient(to bottom left, #c22d5e 40%, #5e0d21 100%);
               margin-left:25%;
               WIDTH:50%;
               color: white;
