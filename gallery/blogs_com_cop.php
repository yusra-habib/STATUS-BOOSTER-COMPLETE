...
mysqli_select_db($con,"aiman_motiv");

// fetching data from database
// start
$result2=mysqli_query($con," SELECT * FROM imagecom  ") or die("failed to query database" . mysqli_error($con));
      ...
      while ($row2=mysqli_fetch_assoc($result2)){
        ...
        echo "<img style='width='300' height='100'' src='$filepath' alt=''>";
            echo "<div class='card_content'>";
              ...
              echo "<button class='btn card_btn'>Read More</button>";
            echo "</div>";
          echo "</div>";
        echo "</li>";
          }
