...
if(isset($_POST['update_btn'])){
    ...
    if($fileName!=''){
        ...
        if(in_array($fileActualExt,$allowed)){
            ...
            $sql="SELECT * FROM blogpak;";
            $stmt=mysqli_stmt_init($conn);
            $fileDestiantion="blog/".$fileName;
            $result1=mysqli_query($conn,"UPDATE blogpak SET blogtitle='$edit_title', bloglink='$edit_link', imageusa='$update_filename' WHERE idblog='$id'")  or die("failed to query database" . mysqli_error($conn));
            ...
            header('location:art_update_pak.php');
        }
    }else{
