...
if(isset($_POST['submit'])){
    ...
    if(in_array($fileActualExt,$allowed)){
        ...
        $result1=mysqli_query($conn,"INSERT INTO blogcom (blogtitle,bloglink,imageusa) VALUES ('$imageTitle','$imagelink','$fileName')")  or die("failed to query database" . mysqli_error($conn));
