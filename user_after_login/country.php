              ...
              <div class="about container">
                ...
                <div class="col-right">
                  ...
                  <section id="services">
                    ...
                    <?php echo "<a href='../user_video/videos_usa_u.php?user_id=$user_id & password=$password'>";?><div class="service-bottom">
                      <div class="service-item">
                        <div class="icon"><img src="https://img.icons8.com/bubbles/100/000000/services.png" /></div>
                        <h2>VIDEOS</h2>
                      </div>
                    </a>
                    <?php echo "<a href='../user_gallery/blogs_com_user.php?user_id=$user_id & password=$password'>";?>
                      ...
                      <?php echo "<a href='../user_blog/dis_art_usa_u.php?user_id=$user_id & password=$password'>
";?>
                        <div class="service-item">
                        <div class="icon"><img src="https://img.icons8.com/bubbles/100/000000/services.png" /></div>
                        <h2>BLOGS</h2>
                  ...
                  <section id="about">
                    <div class="about container">
                      ...
                      <div class="col-right">
                        ...
                        <?php echo "<a href='../user_video/videos_aus_u.php?user_id=$user_id & password=$password'>";?>
<div class="service-bottom">
                          ...
                          <?php echo "<a href='../user_gallery/blogs_aus_user.php?user_id=$user_id & password=$password'>";?>
<div class="service-item">
                              <div class="icon"><img src="https://img.icons8.com/bubbles/100/000000/services.png" /></div>
                              <h2>QUOTES</h2>
                            ...
                            <?php echo "<a href='../user_blog/dis_art_aus_u.php?user_id=$user_id & password=$password'>";?>
<div class="service-item">
                              <div class="icon"><img src="https://img.icons8.com/bubbles/100/000000/services.png" /></div>
                              <h2>BLOGS</h2>
                        ...
                        <section id="about">
                          <div class="about container">
                            ...
                            <div class="col-right">
                              ...
                              <?php echo "<a href=../user_video/video_pak_u.php?user_id=$user_id & password=$password'>";?>
<div class="service-bottom">
                                  <div class="service-item">
                                    <div class="icon"><img src="https://img.icons8.com/bubbles/100/000000/services.png" /></div>
                                    <h2>VIDEOS</h2>
                                ...
                                <?php echo "<a href='../user_gallery/blogs_pak_user.php'>";?><div class="service-item">
                                  ...
                                  <?php echo "<a href='../user_blog/dis_art_pak_u.php?user_id=$user_id & password=$password'>";?>
<div class="service-item">
                                    <div class="icon"><img src="https://img.icons8.com/bubbles/100/000000/services.png" /></div>
                                    <h2>BLOGS</h2>
