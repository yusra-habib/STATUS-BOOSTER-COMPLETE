...
<!-- end -->
  <div class="main">
    <ul class="cards">
      ...
      while ($row2=mysqli_fetch_assoc($result2)){
        ...
        echo 
            ...
            echo"<a  href='vid_del_pak.php?del_id=$row2[id]'> <button style='              
            ...
            echo"<a href='vid_edit_pak.php?edit_id=$row2[id]'> <button type='submit'  name='delete_data' style='              
            background: linear-gradient(to bottom left, #c22d5e 40%, #5e0d21 100%);
            margin-left:25%;
            WIDTH:50%;
            color: white;
    ...
    ?>
      ...
      <a href=".\upload_pak.php"><button class="block" style=" display: block;
  width: 100%;
  border: none;
  background: linear-gradient(to bottom left, #c22d5e 40%, #5e0d21 100%);
