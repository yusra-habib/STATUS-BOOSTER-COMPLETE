...
// start
$result2=mysqli_query($conn," SELECT * FROM videocom") or die("failed to query database" . mysqli_error($conn));
    ...
    <ul class="cards">
      ...
      while ($row2=mysqli_fetch_assoc($result2)){
        ...
        echo 
            ...
            echo"<a  href='vid_del_com.php?del_id=$row2[id]'> <button style='              
            ...
            echo"<a href='vid_edit_com.php?edit_id=$row2[id]'> <button type='submit'  name='delete_data' style='              
            background: linear-gradient(to bottom left, #c22d5e 40%, #5e0d21 100%);
            margin-left:25%;
            WIDTH:50%;
            color: white;
